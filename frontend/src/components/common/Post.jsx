...
const Post = ({ post }) => {
  ...
  const { mutate: likePost, isPending: isLiking } = useMutation({
    ...
    onSuccess: (updatedLikes) => {
      ...
      // We tried using the below statement but it refreshed the whole feed when updating the every click on the like/unlike button
      // queryClient.invalidateQueries({ queryKey: ["posts"] });
    ...
    <>
      <div className="flex gap-2 items-start p-4 mb-2 mt-2 border-b shadow-[0_0_40px_4px_rgba(72,135,202,0.5)] border-gray-700">
        <div className="avatar">
          ...
          >
            <img src={postOwner.profileImg || "/userAvatar.svg"} />
          </Link>
        </div>
        <div className="flex flex-col flex-1">
          ...
          <div className="flex flex-col gap-3 overflow-hidden">
            ...
            {post.img && (
              <img
                src={post.img}
                className="h-80 object-contain rounded-lg border-none"
                alt=""
              />
            )}
          </div>
              ...
              >
                <div className="modal-box rounded border border-gray-600">
                  ...
                  >
                    ...
                    />
                    <button className=" btn  text-white shadow-[0_0_15px_4px_rgba(72,135,202,0.6)] hover:bg-gray-700 hover:opacity-90 rounded-full  ">
